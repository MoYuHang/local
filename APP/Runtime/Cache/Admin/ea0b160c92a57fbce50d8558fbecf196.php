...
<head>
    ...
    <link rel="stylesheet" href="/Studen-Graduation-Project-master/Public/Styles/css/pintuer.css">
    <link rel="stylesheet" href="/Studen-Graduation-Project-master/Public/Styles/css/admin.css">
    <link rel="stylesheet" href="/Studen-Graduation-Project-master/Public/Styles/css/page.css">
    <script src="/Studen-Graduation-Project-master/Public/Styles/js/jquery.js"></script>
    <script src="/Studen-Graduation-Project-master/Public/Styles/js/pintuer.js"></script>
    <script src="/Studen-Graduation-Project-master/Public/Styles/js/respond.js"></script>
</head>

<body>
    <header>
    <div class="lefter">
        <div class="logo"><a href="<?php echo U('Admin/index');?>"><img src="/Studen-Graduation-Project-master/Public/Images/logo.gif" style="height:50px;" alt="后台管理系统" /></a></div>
    </div>
